  ...
  if (!hasMcp) {
    return (
      <div className="flex flex-col items-center justify-center h-full py-20 px-6 text-center">
        ...
        <h2 className="text-base font-bold text-slate-200 mb-1.5">Aguardando conexão MCP</h2>
        <p className="text-sm text-slate-500 max-w-xs leading-relaxed">
          Verifique se o servidor está rodando. Se o erro persistir, suba com{' '}
          <code className="bg-slate-800 border border-slate-700 px-1.5 py-0.5 rounded text-xs font-mono text-slate-300">
            docker compose up
          </code>
          .
        </p>
  ...
  if (!hasApiKey) {
    return (
      <div className="flex flex-col items-center justify-center h-full py-20 px-6 text-center">
        ...
        <h2 className="text-base font-bold text-slate-200 mb-1.5">Configure sua chave de IA</h2>
        <p className="text-sm text-slate-500 max-w-xs leading-relaxed">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full py-16 px-6 text-center">
      ...
      <div className="w-full max-w-lg">
        <p className="text-[10px] font-bold text-slate-700 uppercase tracking-widest mb-3">Sugestões</p>

...
const TOOLS = [
    ...
    },
    {
        ...
        inputSchema: zodToJsonSchema(login_js_1.registerSchema),
    },
    {
        name: 'list_companies',
...
function createServer() {
    const s = new index_js_1.Server({ name: 'filazero-mcp', version: '1.0.0' }, { capabilities: { tools: {}, resources: {}, prompts: {} } });
    ...
    s.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
        ...
        switch (name) {
            ...
            case 'register':
                return (0, login_js_1.register)(login_js_1.registerSchema.parse(input));
            case 'list_companies':
    ...
    s.setRequestHandler(types_js_1.ListResourcesRequestSchema, async () => ({
        resources: [
    ...
    s.setRequestHandler(types_js_1.ReadResourceRequestSchema, async (request) => {
    ...
    s.setRequestHandler(types_js_1.ListPromptsRequestSchema, async () => ({
        prompts: [
            { name: agendar_atendimento_js_1.agendarAtendimentoPrompt.name, description: agendar_atendimento_js_1.agendarAtendimentoPrompt.description, arguments: agendar_atendimento_js_1.agendarAtendimentoPrompt.arguments },
            { name: consultar_agendamento_js_1.consultarAgendamentoPrompt.name, description: consultar_agendamento_js_1.consultarAgendamentoPrompt.description, arguments: consultar_agendamento_js_1.consultarAgendamentoPrompt.arguments },
        ],
    }));
    s.setRequestHandler(types_js_1.GetPromptRequestSchema, async (request) => {
